...
Scenario('@ verify Chat Generation using General AI', ({ I, ChatSonicPage, testData, expectedAssertionsPage, BaseAutomationPage }) => {
    ...
    I.see(expectedAssertionsPage.ChatSonic.gettxtChatLiked);
    ChatSonicPage.clickOnUnLikeIcon();
    I.see(expectedAssertionsPage.ChatSonic.gettxtChatDisLiked);
    ...
    ChatSonicPage.clickOnImagesForDropDown();
    ChatSonicPage.clickOnStableDiffusion();
    I.see(expectedAssertionsPage.ChatSonic.gettxtStableDiffusion);
    ChatSonicPage.clickOnImagesForDropDown();
    ChatSonicPage.clickOnDallE();
    I.see(expectedAssertionsPage.ChatSonic.gettxtDallE);
